...
При старте лаунчер тихо спрашивает `releases/latest`; если есть версия новее, на кнопке «i» появляется
точка, а в панели «О программе» — кнопка «Скачать и установить». Новый exe скачивается в
