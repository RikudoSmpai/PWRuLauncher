...
Кнопка «i» в углу окна → «Проверить обновления». Новая версия скачивается с этой страницы релизов,
сверяется с контрольной суммой и заменяет лаунчер. После этого кнопка «Обновить» переставит локализацию.
